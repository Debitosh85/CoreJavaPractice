...
class ScienceStudent extends Student
{
	...
	public ScienceStudent(String name, int rollNumber, int physicsMark, int chemistryMark, int mathMark)
	{
	...
	public void displayDetails()
	{
		...
		System.out.println("Physics mark is :"+physicsMark);
	...
	{
		double percent = ((physicsMark+chemistryMark+mathMark)/3);
		return percent;
...
class ArtsStudent extends Student
{
	...
	public ArtsStudent(String name,int rollNumber,int historyMark,int geographyMark,int englishMark)
	{
		super(name,rollNumber);
